...
const controllerError={
    ...
    /*              create(for user)                          */
    actionNoRelatedPriority:{rc:51202,msg:{client:`操作错误，请联系管理员`,server:`操作没有对应的权限`}},
    ...
    relatedImpeachAlreadyDeleted:{rc:51210,msg:`举报已经被删除，无法更改举报状态`},
    impeachAlreadyDone:{rc:51212,msg:`举报已经处理完毕，无法继续操作`},
    // notCreatorOfImpeach:{rc:51208,msg:`非举报创建人，无法更改举报状态`},
    forbidToTakeActionForCurrentImpeach:{rc:51214,msg:`未被分配处理当前举报，无法进行任何处理`},

    invalidActionForAdminUser:{rc:51216,msg:`操作不正确`},
