...
/*              public_group             */
async function createPublicGroup_returnId_async({sess,data,app}){
    // let data={values:{}}
    // // data.values[e_part.METHOD]=e_method.CREATE
    // data.values[e_part.RECORD_INFO]={[e_field.IMPEACH_COMMENT.IMPEACH_ID]:impeachId}
    return new Promise(function(resolve,reject){
        request(app).post('/public_group/').set('Accept', 'application/json').set('Cookie',[sess]).send(data)
...
async function updatePublicGroup_returnReturn_async({sess,data,app}){
    // let data={values:{}}
    // // data.values[e_part.METHOD]=e_method.CREATE
    // data.values[e_part.RECORD_INFO]={[e_field.IMPEACH_COMMENT.IMPEACH_ID]:impeachId}
    return new Promise(function(resolve,reject){
