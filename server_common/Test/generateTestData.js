...
async function getUserCryptedUserId_async({app,adminApp}){
    ...
    return Promise.resolve({
        adminUser1IdCryptedByUser1:await commonAPI.cryptObjectId_async({objectId:user1Id,sess:user1Sess}),
        adminUser1IdCryptedByUser2:await commonAPI.cryptObjectId_async({objectId:user1Id,sess:user2Sess}),
        adminUser1IdCryptedByUser3:await commonAPI.cryptObjectId_async({objectId:user1Id,sess:user3Sess}),
        adminUser2IdCryptedByUser1:await commonAPI.cryptObjectId_async({objectId:user2Id,sess:user1Sess}),
        adminUser2IdCryptedByUser2:await commonAPI.cryptObjectId_async({objectId:user2Id,sess:user2Sess}),
        adminUser2IdCryptedByUser3:await commonAPI.cryptObjectId_async({objectId:user2Id,sess:user3Sess}),
        adminUser3IdCryptedByUser1:await commonAPI.cryptObjectId_async({objectId:user3Id,sess:user1Sess}),
        adminUser3IdCryptedByUser2:await commonAPI.cryptObjectId_async({objectId:user3Id,sess:user2Sess}),
        adminUser3IdCryptedByUser3:await commonAPI.cryptObjectId_async({objectId:user3Id,sess:user3Sess}),
