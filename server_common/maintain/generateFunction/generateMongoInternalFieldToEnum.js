...
function generateFieldEnum(internalInputRuleFilePath,skipCollNameArray){
    // console.log(`internalInputRuleFilePath==========>${JSON.stringify(internalInputRuleFilePath)}`)
    // const internalInputRule=require('h:/ss_vue_express/server_common/constant/inputRule/internalInputRule').internalInputRule
    const internalInputRule=require(internalInputRuleFilePath).internalInputRule
...
function writeFinalResult(internalInputRuleFilePath,resultWriteFilePath,skipCollNameArray){
    ...
    let result=generateFieldEnum(internalInputRuleFilePath,skipCollNameArray)
