...
// const browserInputRule=require('../../../../constant/inputRule/browserInput/friend/user_public_group').user_public_group
const internalInputRule=require('../../../../constant/inputRule/internalInput/friend/user_public_group').user_public_group
//根据inputRule的rule设置，对mongoose设置内建validator
let collInputRule=internalInputRule
/*if(browserInputRule) {
    Object.assign({},browserInputRule)
}
if(internalInputRule){
    Object.assign({},internalInputRule)
}*/
