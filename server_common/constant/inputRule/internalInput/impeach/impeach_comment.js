...
const impeach_comment= {
    ...
    authorId: {
        ...
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:false}, error: {rc: 10570, msg: '评论作者不能为空'}, mongoError: {rc: 20570, msg: '评论作者不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        ...
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10571, msg: '评论作者必须是objectId'}, mongoError: {rc: 20571, msg: '评论作者必须是objectId'}} //server端使用
    },
    adminAuthorId: {
        [otherRuleFiledName.CHINESE_NAME]: '评论作者',      //admin用户
        [otherRuleFiledName.DATA_TYPE]: serverDataType.OBJECT_ID,
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE],
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:false}, error: {rc: 10572, msg: '评论作者不能为空'}, mongoError: {rc: 20572, msg: '评论作者不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        // [ruleFiledName.MIN_LENGTH]: {define: 6, error: {rc: 10002}, mongoError: {rc: 20002, msg: '密码至少6个字符'}},
        // [ruleFiledName.MAX_LENGTH]: {define: 20, error: {rc: 10004}, mongoError: {rc: 20004, msg: '密码的长度不能超过20个字符'}},
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10573, msg: '评论作者必须是objectId'}, mongoError: {rc: 20573, msg: '评论作者必须是objectId'}} //server端使用
    },
    ...
    impeachImagesId: {
        ...
        [otherRuleFiledName.DATA_TYPE]: [serverDataType.OBJECT_ID],
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE],
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:false}, error: {rc: 10574, msg: '评论图片不能为空'}, mongoError: {rc: 20574, msg: '评论图片不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
    ...
    impeachAttachmentsId: {
        ...
        [otherRuleFiledName.DATA_TYPE]: [serverDataType.OBJECT_ID],
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE],
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:false}, error: {rc: 10580, msg: '评论附件不能为空'}, mongoError: {rc: 20580, msg: '评论附件不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        // 'arrayMinLength': {define: 1, error: {rc: 10002}, mongoError: {rc: 20002, msg: '至少设置1个标签'}},
        'arrayMaxLength': {define: maxNumber.impeachAttachment.maxAttachmentNumber, error: {rc: 10582, msg: `评论中最多添加${maxNumber.impeachAttachment.maxAttachmentNumber}个附件`}, mongoError: {rc: 20582, msg: `评论中最多添加${maxNumber.impeachAttachment.maxAttachmentNumber}个附件`}},
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10584, msg: '评论附件必须是objectId'}, mongoError: {rc: 20584, msg: '评论附件必须是objectId'}} //server端使用
    },
    ...
    documentStatus:{
        ...
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE],
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true}, error: {rc: 10586, msg: '记录状态不能为空'}, mongoError: {rc: 20586, msg: '记录状态不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        // 'arrayMinLength': {define: 1, error: {rc: 10002}, mongoError: {rc: 20002, msg: '至少设置1个标签'}},
