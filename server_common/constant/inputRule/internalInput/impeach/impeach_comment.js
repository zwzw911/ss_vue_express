...
const impeach_comment= {
    ...
    authorId: {
        ...
        'require': {define: false, error: {rc: 10570}, mongoError: {rc: 20570, msg: '评论作者不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        // 'minLength': {define: 6, error: {rc: 10002}, mongoError: {rc: 20002, msg: '密码至少6个字符'}},
        // 'maxLength': {define: 20, error: {rc: 10004}, mongoError: {rc: 20004, msg: '密码的长度不能超过20个字符'}},
        'format': {define: regex.objectId, error: {rc: 10571}, mongoError: {rc: 20571, msg: '评论作者必须是objectId'}} //server端使用
    },
    adminAuthorId: {
        'chineseName': '评论作者',
        'type': serverDataType.OBJECT_ID,
        'require': {define: false, error: {rc: 10572}, mongoError: {rc: 20572, msg: '评论作者不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        // 'minLength': {define: 6, error: {rc: 10002}, mongoError: {rc: 20002, msg: '密码至少6个字符'}},
        // 'maxLength': {define: 20, error: {rc: 10004}, mongoError: {rc: 20004, msg: '密码的长度不能超过20个字符'}},
        'format': {define: regex.objectId, error: {rc: 10573}, mongoError: {rc: 20573, msg: '评论作者必须是objectId'}} //server端使用
    },
