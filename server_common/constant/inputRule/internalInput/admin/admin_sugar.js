...
const baseJSErrorCode=100150
const baseMongoErrorCode=200150
...
/*        [ruleFiledName.MIN_LENGTH]: {define: 1, error: {rc: 10002}, mongoError: {rc: 20002, msg: '糖至少1个字符'}},
        ...
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: baseJSErrorCode+2, msg: '用户id由24个字符组成'}, mongoError: {rc: baseMongoErrorCode+2, msg: '用户id由24个字符组成'}} //server端使用
    },
    sugar: {
        ...
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE],
        //require=false：client无需此字段，server通过函数（必须有salt来sha密码）保证由此字段
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true}, error: {rc: baseJSErrorCode+4, msg: '糖不能为空'}, mongoError: {rc: baseMongoErrorCode+4, msg: '糖不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        ...
        [ruleFiledName.FORMAT]: {define: regex.salt, error: {rc: baseJSErrorCode+6, msg: '糖必须由1-10个字符组成'}, mongoError: {rc: baseMongoErrorCode+6, msg: '糖必须由1-10个字符组成'}} //server端使用
    },
