...
const store_path= {
     usedSize: {
        ...
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true,[applyRange.UPDATE_SCALAR]:true}, error: {rc: 10075, msg: '已使用容量不能为空'}, mongoError: {rc: 20075, msg: '已使用容量不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
    ...
    status: {
        ...
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE,applyRange.UPDATE_SCALAR],
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true,[applyRange.UPDATE_SCALAR]:false}, error: {rc: 10076, msg: '存储路径状态不能为空'}, mongoError: {rc: 20076, msg: '存储路径状态不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        [ruleFiledName.ENUM]:{define:enumValue.StorePathStatus,error:{rc:10077,msg:'存储路径状态不正确'},mongoError:{rc:20077,msg:'存储路径状态不正确'}},//server端使用
        // 'min': {define: 1, error: {rc: 10314}, mongoError: {rc: 20314, msg: '处罚时间最少1天'}},
        // 'max': {define: 30, error: {rc: 10316}, mongoError: {rc: 20316, msg: '处罚时间最多30天'}},
        // [ruleFiledName.MIN_LENGTH]: {define: 1, error: {rc: 10002}, mongoError: {rc: 30002, msg: '分类名至少1个字符'}},
        // [ruleFiledName.MAX_LENGTH]: {define: 50, error: {rc: 10004}, mongoError: {rc: 30004, msg: '分类名的长度不能超过50个字符'}},
