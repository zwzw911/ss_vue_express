...
const user_public_group= {
    userId: {
        ...
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true}, error: {rc: 10430}, mongoError: {rc: 20430, msg: '用户不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        ...
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10432}, mongoError: {rc: 20432, msg: '用户必须是objectId'}} //server端使用
    },
    ...
    currentJoinGroup: {
        ...
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:false,[applyRange.UPDATE_SCALAR]:false}, error: {rc: 10434}, mongoError: {rc: 20434, msg: '用户所处群不能为空'}},//若尚未加入任何群，字段为空
        ...
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10438}, mongoError: {rc: 20438, msg: '用户所处群必须是objectId'}} //server端使用
    },
