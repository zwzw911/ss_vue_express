...
/*    pureContent: {
    ...
    htmlContent: {
        'chineseName': '文档内容',
        'type': serverDataType.STRING,
        'require': {define: true, error: {rc: 10114}, mongoError: {rc: 20114, msg: '文档内容不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        'minLength': {define: 15, error: {rc: 10116}, mongoError: {rc: 20116, msg: '文档内容至少15个字符'}},
        'maxLength': {define: 50000, error: {rc: 10118}, mongoError: {rc: 20118, msg: '文档内容的长度不能超过50000个字符'}},
        // 'format': {define: regex.folderFileName, error: {rc: 10005}, mongoError: {rc: 30005, msg: '文档名必须由1-255个字符组成'}} //server端使用
    },
    //输入的时候是字符
    tags: {
