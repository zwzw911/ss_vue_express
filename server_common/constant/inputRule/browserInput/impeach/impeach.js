...
const impeach= {
    title: {
        ...
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true,[applyRange.UPDATE_SCALAR]:false}, error: {rc: 10500}, mongoError: {rc: 20500, msg: '举报名不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        [ruleFiledName.MIN_LENGTH]: {define: 2, error: {rc: 10502}, mongoError: {rc: 20502, msg: '举报名至少2个字符'}},
        [ruleFiledName.MAX_LENGTH]: {define: 50, error: {rc: 10504}, mongoError: {rc: 20504, msg: '举报名的长度不能超过50个字符'}},
    ...
    content: {
        ...
        [otherRuleFiledName.DATA_TYPE]: serverDataType.STRING,
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE,applyRange.UPDATE_SCALAR],
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true,[applyRange.UPDATE_SCALAR]:false}, error: {rc: 10506}, mongoError: {rc: 20506, msg: '举报内容不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        [ruleFiledName.MIN_LENGTH]: {define: 5, error: {rc: 10508}, mongoError: {rc: 20508, msg: '举报内容至少5个字符'}},
        [ruleFiledName.MAX_LENGTH]: {define: 1999, error: {rc: 10510}, mongoError: {rc: 20510, msg: '举报内容的长度不能超过1999个字符'}},
    ...
    impeachedArticleId: {
        ...
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE,applyRange.UPDATE_SCALAR],
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:false,[applyRange.UPDATE_SCALAR]:false}, error: {rc: 10512}, mongoError: {rc: 20512, msg: '举报的文档不能为空'}},//默认为空对象
        ...
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10514}, mongoError: {rc: 20514, msg: '举报的文档必须是objectId'}} //server端使用
    },
    ...
    impeachedCommentId: {
        ...
        [otherRuleFiledName.DATA_TYPE]: serverDataType.OBJECT_ID,
        [otherRuleFiledName.APPLY_RANGE]:[applyRange.CREATE,applyRange.UPDATE_SCALAR],
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:false,[applyRange.UPDATE_SCALAR]:false}, error: {rc: 10516}, mongoError: {rc: 20516, msg: '举报的评论不能为空'}},//默认为空对象
            // 'arrayMinLength': {define: 0, error: {rc: 10002}, mongoError: {rc: 20002, msg: '至少设置1个标签'}},
            //'arrayMaxLength': {define: maxNumber.article.imagesNumberPerArticle, error: {rc: 10004}, mongoError: {rc: 20004, msg: `最多插入${maxNumber.article.imagesNumberPerArticle}个图片`}},
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10518}, mongoError: {rc: 20518, msg: '举报的评论必须是objectId'}} //server端使用
    }
}
