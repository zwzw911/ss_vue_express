...
const impeach_image= {
    referenceId: {
        ...
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true}, error: {rc: 10634, msg: '举报对象不能为空'}, mongoError: {rc: 20634, msg: '举报对象不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        ...
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10636, msg: '举报对象必须是objectId'}, mongoError: {rc: 20636, msg: '举报对象必须是objectId'}} //server端使用
    },
