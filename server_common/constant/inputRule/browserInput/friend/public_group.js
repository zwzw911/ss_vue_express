...
const ruleFiledName=require('../../../enum/inputDataRuleType').RuleFiledName
const otherRuleFiledName=require('../../../enum/inputDataRuleType').OtherRuleFiledName
const applyRange=require('../../../enum/inputDataRuleType').ApplyRange
