...
const add_friend= {
    receiver: {
        ...
        [ruleFiledName.REQUIRE]: {define: {[applyRange.CREATE]:true}, error: {rc: 10440}, mongoError: {rc: 20440, msg: '添加好友不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        ...
        [ruleFiledName.FORMAT]: {define: regex.objectId, error: {rc: 10442}, mongoError: {rc: 20442, msg: '好友必须是objectId'}} //server端使用
    },
    ...
    status:{
        ...
        [ruleFiledName.REQUIRE]: {define: {[applyRange.UPDATE_SCALAR]:true}, error: {rc: 10444}, mongoError: {rc: 20444, msg: '状态不能为空'}},//
        ...
        [ruleFiledName.ENUM]: {define: enumValue.AddFriendStatus, error: {rc: 10446}, mongoError: {rc: 20446, msg: '状态未定义'}} //server端使用
    },
