 ...
 */
"use strict";
const testModel=require('../../../../../server/model/mongo/structure/article/article_attachment').collModel;
// let testSch=require('../../../../../server/model/mongo/structure/admin/admin_user').collSchema;

// const browserInputRule=require('../../../../../server/constant/inputRule/browserInput/article/article_a').article
const internalInputRule=require('../../../../../server/constant/inputRule/internalInput/article/article_attachment').article_attachment
...
const correctValue={
    name:'attt.txt',
    hashName:'1234568790123456879012345678901234567890.txt',
...
const  validatePathValue=function(test){
    ...
    //3 format test
    generateTestCase({fieldName:'name',singleRuleName:serverRuleType.FORMAT,correctValue:correctValue,collInputRule:collInputRule,testModel:testModel,test:test})
