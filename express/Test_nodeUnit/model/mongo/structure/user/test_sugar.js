 ...
 */
"use strict";
let testModel=require('../../../../../server/model/mongo/structure/user/sugar').collModel;
// let testSch=require('../../../../../server/model/mongo/structure/admin/admin_sugar').collSchema;

// const browserInputRule=require('../../../../../server/constant/inputRule/browserInput/user/').admin_sugar
const internalInputRule=require('../../../../../server/constant/inputRule/internalInput/user/suagr').sugar
