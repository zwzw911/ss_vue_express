    ...
    switch (method){
        case e_method.CREATE: //create
            ...
            if(undefined!==req.body.values[e_part.RECORD_INFO]){
                ...
                // console.log(`req.body.values[e_part.RECORD_INFO]===========>${JSON.stringify(req.body.values[e_part.RECORD_INFO])}`)
                // console.log(`defaultDocValue===========>${JSON.stringify(defaultDocValue)}`)
