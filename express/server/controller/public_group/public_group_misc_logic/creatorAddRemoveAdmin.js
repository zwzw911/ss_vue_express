...
/*    //确认rule是批准加入（才能进行）
    ...
    // //add/remove中每个元素必须位于ADMINS_ID中
    // for(let keyValues of manipulateArrayValue[e_field.PUBLIC_GROUP.ADMINS_ID]){
...
// ap.inf('updateFieldsValue',updateFieldsValue)
    ...
    if(groupRecord[e_field.PUBLIC_GROUP.JOIN_IN_RULE]===e_publicGroupJoinInRule.PERMIT_ALLOW){
        docValue={$addToSet:{[e_field.PUBLIC_GROUP.ADMINS_ID]:userId}}
    }*/
    /*******************************************************************************************/
    /*                                       authorization check                               */
    /*******************************************************************************************/
