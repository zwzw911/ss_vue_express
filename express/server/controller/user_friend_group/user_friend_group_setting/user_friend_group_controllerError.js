...
const controllerError={
    ...
    inPenalizeCantCreateUserFriendGroup:{rc:51702,msg:`您被禁止创建好友分组`},
    //update
    notLoginCantUpdateUserFriendGroup:{rc:51704,msg:`尚未登录，无法更新好友分组`},
    inPenalizeCantUpdateUserFriendGroup:{rc:51706,msg:`您被禁止对好友分组更新`},
    //delete
    notLoginCantDeleteUserFriendGroup:{rc:51708,msg:`尚未登录，无法删除好友分组`},
    inPenalizeCantDeleteUserFriendGroup:{rc:51710,msg:`您被禁止删除好友分组`},
    //08～20预留给其他method
    /*              logic                           */
    //create
