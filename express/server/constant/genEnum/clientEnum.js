...
const ResourceRange=
    {"1":"用户文档所有资源","10":"文档图片","12":"文档附件","14":"举报（或者评论）图片","16":"举报中的用户","18":"最大目录数量","20":"最大朋友群数量","22":"群人数数量","24":"最大未处理的添加朋友的请求数","26":"最大已同意但是未被分配的添加朋友的请求数","28":"新建但未做过任何处理的文档数","30":"最大文档数","32":"文档最大评论数","34":"用户对文档的最大评论数"}
