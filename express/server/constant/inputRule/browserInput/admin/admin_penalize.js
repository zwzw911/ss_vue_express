...
const admin_penalize= {
    ...
    punishedId: {
        ...
        'format': {define: regex.objectId, error: {rc: 10082}, mongoError: {rc: 20082, msg: '受罚人格式不正确'}} //server端使用
    },
    ...
    reason: {
        ...
        'require': {define: true, error: {rc: 10084}, mongoError: {rc: 20084, msg: '受罚原因不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        'minLength': {define: 15, error: {rc: 10086}, mongoError: {rc: 20086, msg: '受罚原因至少15个字符'}},
        'maxLength': {define: 1000, error: {rc: 10088}, mongoError: {rc: 20088, msg: '受罚原因的字数不能超过1000个字符'}},
