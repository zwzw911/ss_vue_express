...
const user_friend_group= {
    name: {
        ...
        'require': {define: true, error: {rc: 10000}, mongoError: {rc: 30000, msg: '朋友分组名不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
