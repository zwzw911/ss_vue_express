...
const article= {
    name: {
        ...
        'minLength': {define: 2, error: {rc: 10102}, mongoError: {rc: 10102, msg: '文档名至少2个字符'}},
    ...
    htmlContent: {
        'chineseName': '格式内容',
        'type': serverDataType.STRING,
        'require': {define: true, error: {rc: 10120}, mongoError: {rc: 20120, msg: '格式内容不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        'minLength': {define: 1, error: {rc: 10122}, mongoError: {rc: 20122, msg: '格式内容至少1个字符'}},
        'maxLength': {define: 50000, error: {rc: 10124}, mongoError: {rc: 20124, msg: '格式内容的长度不能超过50000个字符'}},
        // 'format': {define: regex.folderFileName, error: {rc: 10005}, mongoError: {rc: 30005, msg: '文档名必须由1-255个字符组成'}} //server端使用
    },
