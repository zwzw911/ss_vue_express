...
const article= {
    ...
    tagsId: {
        'chineseName': '标签',
        'type': [serverDataType.OBJECT_ID],
        'require': {define: true, error: {rc: 10134}, mongoError: {rc: 20134, msg: '文档标签不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        ...
        'format': {define: regex.objectId, error: {rc: 10140}, mongoError: {rc: 20140, msg: '文档分类必须是objectId'}} //server端使用
    },
    //虽然mongodb中定义的是array+objectId，但是实际处理时，从client传递的只是objectId，所以定义的时候，只检查objectId
    articleImagesId: {
        'chineseName': '文档图片',
