...
const article_attachment= {
    name: {
        ...
        'require': {define: true, error: {rc: 10000}, mongoError: {rc: 30000, msg: '文档附件名称不能为空'}},//mongoError在mongovalidator中，从Object转换成String，因为mongo的validtor只能接受String作为fail的返回信息
        'minLength': {define: 4, error: {rc: 10002}, mongoError: {rc: 30002, msg: '文档附件名称至少4个字符'}},
        'maxLength': {define: 255, error: {rc: 10004}, mongoError: {rc: 30004, msg: '文档附件的长度不能超过255个字符'}},
        'format': {define: regex.fileName, error: {rc: 10005}, mongoError: {rc: 30005, msg: '文档附件必须由4-255个字符组成'}} //server端使用
    },
    hashName: {
        'chineseName': '文档附件名称',
        'type': serverDataType.STRING,
        ...
        'format': {define: regex.hashAttachmentName, error: {rc: 10005}, mongoError: {rc: 30005, msg: 'hash文档名必须由43~44个字符组成'}} //server端使用
    },
    pathId: {
        'chineseName': '存储路径',
    ...
    size:{
        ...
        'max': {define: uploadFileDefine.article_attachment.maxSizeInByte, error: {rc: 10004}, mongoError: {rc: 20004, msg: `附件大小不能超过${uploadFileDefine.article_attachment.maxSizeInMB}MB`}},
        // 'format': {define: regex.objectId, error: {rc: 10005}, mongoError: {rc: 20005, msg: '存储路径必须是objectId'}} //server端使用
    },
    authorId: {
        'chineseName': '附件上传者',
