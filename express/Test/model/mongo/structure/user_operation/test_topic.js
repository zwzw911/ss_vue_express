 ...
 */
"use strict";
let testModel=require('../../../../../server/model/mongo/structure/user_operation/topic').collModel;
// let testSch=require('../../../../../server/model/mongo/structure/admin/admin_sugar').collSchema;

const browserInputRule=require('../../../../../server/constant/inputRule/browserInput/user_operation/topic').topic
const internalInputRule=require('../../../../../server/constant/inputRule/internalInput/user_operation/topic').topic
