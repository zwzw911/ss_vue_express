 ...
 */
"use strict";
const testModel=require('../../../../../server/model/mongo/structure/impeach/impeach_attachment').collModel;
// let testSch=require('../../../../../server/model/mongo/structure/admin/admin_user').collSchema;

// const browserInputRule=require('../../../../../server/constant/inputRule/browserInput/impeach/impeach_attachment').i
const internalInputRule=require('../../../../../server/constant/inputRule/internalInput/impeach/impeach_attachment').impeach_attachment
